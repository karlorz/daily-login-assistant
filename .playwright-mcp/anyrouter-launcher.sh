...
# Session: 90b5d0d3-2359-4411-9094-65c54bd50e7d
set -e

# Configuration (server-injected)
SESSION_TOKEN="90b5d0d3-2359-4411-9094-65c54bd50e7d"
...
"$CHROME_EXEC" --remote-debugging-port=${DEBUG_PORT} \
  ...
  --remote-allow-origins=http://localhost:8001,http://ssh-tunnel:9222 \
  --no-first-run \
  --disable-fre \
